"""
Django settings for upgrad_project project.
...
SECRET_KEY = '2250di-n0(qixn2)!n0wzytuz9g$ix##gnq265n&lk+u8jgc6u'
...
ROOT_URLCONF = 'upgrad_project.urls'
...
WSGI_APPLICATION = 'upgrad_project.wsgi.application'
...
t = datetime.today()
ONE_MINUTE_AFTER = crontab(minute=t.minute + 1, hour=t.hour)
...
EMAIL_PORT= 587
EMAIL_HOST_USER = 'vitstuffofficial@gmail.com'
EMAIL_HOST_PASSWORD = '8142642805'
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False